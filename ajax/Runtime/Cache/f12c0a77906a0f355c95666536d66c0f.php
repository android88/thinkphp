    ...
    <div class="main">
        ...
        <form id="form1" method='post' action="__URL__/insert">
            <table cellpadding=2 cellspacing=2>
                ...
                <tr>
                    <td colspan="2"><div id = "result2" class="result" style="display:none;"></div></td>
                </tr>
                <tr>
                    <td >标题：</td>
                    <td ><input type="text" name="title" id="title"> <input type="button" value="检 查" class="button" onClick="checkTitle2()"></td>
                </tr>
                <tr>
                    <td >内容：</td>
